...
public class EquipmentManager : MonoBehaviour
{
    ...
    private void CalculateStats()
    {
        ...
        if (equippedHat != null)
        {
            currentMaxMana += equippedHat.ManaBonus;
        }

        if (equippedCloak != null)
        {
            currentMaxHealth += equippedCloak.HealthBonus;
        }

        if (equippedBoots != null)
        {
            currentMoveSpeed *= equippedBoots.SpeedMultiplier;
        }

        if (equippedReliquary != null)
        {
            currentXpRadius += equippedReliquary.XpCollectRadiusBonus;
        }
    }
